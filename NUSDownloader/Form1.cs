...
// MTP                this.Invoke(wsc, new object[] { Update, writecolor });
                return;
            }
        ...
        public void NUSDownloader_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
       ...
       private void RunScriptBg(object sender, System.ComponentModel.DoWorkEventArgs e)
       {
        ...
        public void SetLocalUse (bool localUseVal)
        {
            localuse.Checked = localUseVal;
        }
        public void SetPackWad (bool packWadVal)
        {
            packbox.Checked = packWadVal;
        }
        ...
        {
            titleversion.Text = titleVersion;
        }

        public void SetKeepEncryptedContent(bool encryptContent)
        {
            keepenccontents.Checked = encryptContent;
        }

        public void SetServerButtonText (string serverText)
        {
