...
namespace UnitTests
{
    public class Tests
    {
        ...
        private const string EXECUTABLE_NAME = "NUSDownloaderNet6.exe";
        ...
        private void SetNusOptions(ref NusDownloader nusDownloader, string[] options)
        {
            ...
            foreach (string nusOption in options)
            {
                switch (nusOption.ToLower())
                {
                    ...
                    case "wii":
                    case "dsi":
                        nusDownloader.SetNusType(nusOption);
                        break;
                    ...
                    default:
                        ...
                        {
                            nusDownloader.SetCustomNusUrl(nusOption);
                        }
                        break;
                }
            }
            if ((TruchaBugEnable == true) || (ESIdentityPatchEnable == true) || (NandPermissionPatchEnable == true))
            {
                ...
                {
                    nusDownloader.SetTruchaBugEnable(true);
                }
                if (ESIdentityPatchEnable == true)
                {
                    nusDownloader.SetEsIdentityBugEnable(true);
                }
                if (NandPermissionPatchEnable == true)
                {
                    nusDownloader.SetNandPermissionBugEnable(true);
                }
            }
        }
        ...
        public void CreateForm1Success()
        {
            ...
            NusDownloader nusForm = new NusDownloader();
        ...
        public void DownloadNusSuccess(string titleId, string titleVersion, string[] options = null)
        {
            ...
            Assert.DoesNotThrow(() => nusForm.NUSDownloader_DoWork());
        ...
        public void TestInvalidUrl(string titleId, string titleVersion, string[] options = null)
        {
            ...
            var ex = Assert.Throws<Exception>(() => nusForm.NUSDownloader_DoWork());
